<!--
    ...
    Implementare mediante Servlet una o piú pagine web che presentino:
...
<%
    ...
    String query = "SELECT * FROM flist ORDER BY RAND() LIMIT 1";
    PreparedStatement stmt = conn.prepareStatement(query);
    ResultSet res = stmt.executeQuery();

    String title="";
    if (res.next())
        title = res.getString("titolo");
%>
...
<html>
    ...
    <body>
        ...
        <h1>Film consigliato: <%=title%></h1><br>
